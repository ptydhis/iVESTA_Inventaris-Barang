...
// Ambil id_nip dari session
$id_nip = $_SESSION['id_nip'];

// Query total riwayat peminjaman user, kecuali status yang belum selesai
$query_riwayat = "SELECT COUNT(*) AS total_riwayat FROM t_pinjam WHERE id_nip = '$id_nip' AND status_peminjaman NOT IN ('Menunggu Verifikasi', 'Dipinjam')";
...
$query_barang = "SELECT COUNT(*) AS total_barang FROM t_barang_detail WHERE status = 'Tersedia'";
...
<body>
    ...
    <div class="sidebar" id="sidebar">
        ...
        <div class="sidebar-menu">
            ...
            <a href="userData/Barang.php">
                <i class="fas fa-box menu-icon"></i>
                <span>Barang</span>
            </a>
            <a href="userData/Peminjaman.php">
                <i class="fas fa-hand-holding menu-icon"></i>
                <span>Peminjaman</span>
            </a>
            <a href="userData/Riwayat.php">
            ...
            <div class="row g-4 mb-4">
                ...
                <div class="col-md-4">
                    <div class="card-dashboard card text-center p-4">
                        ...
                        <span
                            class="card-value"><?= isset($barang['total_barang']) ? $barang['total_barang'] : 0 ?></span>
                ...
                <div class="col-md-4">
                    <div class="card-dashboard card text-center p-4">
                        ...
                        <span class="card-text">Peminjaman Aktif</span>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="card-dashboard card text-center p-4">
                        ...
                        <span class="card-value"><?= $riwayat['total_riwayat'] ?></span>
                        <span class="card-text">Riwayat Pinjam</span>
                    </div>
                </div>
            </div>

            <!-- About Us Section -->
            <div class="row mt-5 align-items-center" style="margin-bottom: 0 !important;">
                <!-- Text Content -->
                <div class="col-md-8 pe-lg-4">
                    <h2 class="mb-4">About iVESTA</h2>
                    <div class="text-content"
                        style="text-align: justify; text-justify: inter-word; word-wrap: break-word;">
                        <p class="mb-3">
                            <strong>iVESTA</strong> (Inventory System Academic) adalah sistem informasi berbasis web
                            yang
                            dirancang untuk membantu pengelolaan inventaris di lingkungan program studi (prodi).
                            Sistem ini bertujuan untuk menyediakan solusi digital yang efisien, transparan,
                            dan terstruktur dalam mencatat, memantau, serta mengelola aset atau barang milik prodi.
                        </p>

                        <p class="mb-3">
                            Dengan antarmuka yang ramah pengguna, iVESTA memungkinkan pengguna untuk:
                        </p>

                        <ul class="mb-0 ps-3" style="text-align: justify;">
                            <li class="mb-2">Menambahkan dan memperbarui data barang dengan mudah.</li>
                            <li class="mb-2">Melacak ketersediaan, kondisi, dan status peminjaman barang.</li>
                            <li class="mb-2">Melihat histori penggunaan dan laporan inventaris secara real-time.</li>
                            <li class="mb-0">Memastikan akurasi dan keamanan data melalui sistem terpusat.</li>
                        </ul>
                    </div>
                </div>
                ...
                <!-- Image Column -->
                <div class="col-md-4">
                    <div class="about-image p-3">
                        <img src="../assets/img/Logo iVESTA.png" alt="iVESTA System"
